...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/data_transfer.ImportServersResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "data_transfer.ImportServersResponse": {
            "type": "object",
            "properties": {
                "failed_count": {
                    "type": "integer"
                ...
                "failures": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data_transfer.ImportFailure"
                    }
                },
                "success_count": {
                    "type": "integer"
